...
function userMessage(message) {
    ...
    xhr.onload = function () {
        ...
        if (xhr.status === 200 && xhr.responseText) {
            ...
            displayMessage("Disculpe pero no entiendo su pregunta, Pero le puedo hablar de los productos y servicios de SOAINT.", watson);
        }
    };
    xhr.onerror = function () {
        console.error('Network error trying to send message!');
        displayMessage("Oops, mi cerebro está offline. Espera un minuto para continuar por favor.", watson);
    };
